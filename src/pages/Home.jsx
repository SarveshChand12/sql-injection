            ...
            <div className="max-w-md mx-auto pt-20">
                ...
                <div className="mt-12 space-y-6">
                    ...
                    <div className="bg-gray-800 p-6 rounded-lg shadow-md">
                        ...
                        <p className="text-gray-400 mb-4">All reports are anonymous and stored securely.</p>
                        <p>For urgent cases or ongoing threats, please contact local authorities or cybersecurity agencies in Fiji.</p>
                        <Link to="https://forms.gle/E4zdqGgoB6emGP849" className="text-blue-400 hover:underline">
                            Report an Incident
                        </Link>
                    </div>
                </div>
